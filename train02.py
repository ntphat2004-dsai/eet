...
def main(args):
    ...
    with mlflow.start_run(run_name=args.run_name):
        ...
        temp_subsample_factor = args.temporal_subsample_factor  # temporal subsample factor

        # Label transformation: Scale and normalize
        ...
        # Xác định slicing parameters dựa vào thời gian và tần số subsample
        ...
        # Với validation, không chồng lắp các subsequence
        ...
        # Sau khi slice, chuyển đổi thành event voxel-grid
        ...
        # Sử dụng SlicedDataset để cắt recording thành subsequences
        ...
        # Cache dataset để tăng tốc độ training
